...
/*This project utilizes SQL to analyze data on employee layoffs within a company. We’ll clean the given data related to layoffs and prepare it for accurate analysis.
By working on this project. One will gain experience in:

•	Writing effective SQL queries for data manipulation and analysis.
•	Cleaning and transforming data for meaningful insights.*/
